...
def main():
    ...
    # Dos posibilidades : HOST --> '0.0.0.0' o '127.0.0.1' que corresponde a 'escuchar desde fuera' o 'desde dentro'
    # Para el proyecto nos vale con 127.0.0.1
